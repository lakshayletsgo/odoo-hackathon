...
import { Search, MapPin, Star, Filter, Grid, List, Clock, DollarSign } from "lucide-react"
...
const sports = ["All Sports", "Tennis", "Basketball", "Football", "Volleyball", "Badminton", "Squash"]
const sortOptions = [
...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    const filteredVenues = mockVenues.filter((venue) => {
      ...
      const matchesLocation = location === "" || venue.city.toLowerCase().includes(location.toLowerCase())
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{venues.length} courts found</h1>
            <p className="text-gray-600">
              {location && `in ${location}`} {selectedSport !== "All Sports" && `for ${selectedSport}`}
            </p>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-gray-500 text-sm">({venue.totalRatings})</span>
                        </div>
                        <p className="text-sm text-gray-500 mt-1">{venue.distance} miles away</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4 text-sm text-gray-600">
                        ...
                        <span className="flex items-center">
                          ...
                          {formatCurrency(venue.priceRange[0])}-{formatCurrency(venue.priceRange[1])}/hr
                        </span>
                      </div>
                    </div>
